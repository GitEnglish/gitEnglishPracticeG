...
export const EXERCISE_INFO: Record<ExerciseType, ExerciseInfo> = {
  [ExerciseType.FITB]: {
    ...
    description: 'You complete a sentence by filling in a missing word. It focuses on vocabulary or grammar in a controlled context.',
  ...
  [ExerciseType.MultipleChoice]: {
    ...
    description: 'You select the correct answer from a set of options to complete a sentence or answer a question.',
  ...
  [ExerciseType.SentenceScramble]: {
    ...
    description: 'Words of a sentence are given in a jumbled order, and you must rearrange them to form a coherent sentence.',
    pedagogy: 'A PPP exercise focusing on syntax and word order. It helps you internalize grammatical structures through manipulation.',
    example: 'Scrambled: [is, cat, the, sleeping]. Correct: The cat is sleeping.',
    difficultyRating: Difficulty.A1,
  },
  [ExerciseType.ClozeParagraph]: {
    name: 'Cloze Paragraph',
    description: 'A text where words have been removed. You fill in the gaps, often using a word bank. It tests comprehension and vocabulary.',
  ...
  [ExerciseType.Matching]: {
    name: 'Matching',
    description: 'You draw lines between items in two columns or pair them up, such as words and definitions, or questions and answers.',
    pedagogy: 'A versatile PPP activity for reinforcing connections, such as vocabulary and meaning, or grammatical forms and your functions.',
    example: 'Match words to definitions: 1. Apple -> a) A yellow fruit. 2. Banana -> b) A red fruit.',
    difficultyRating: Difficulty.A1,
  },
  [ExerciseType.ErrorCorrection]: {
    name: 'Error Correction',
    description: 'You are given sentences containing grammatical errors and must identify and correct them.',
  ...
  [ExerciseType.DialogueCompletion]: {
    ...
    description: 'You fill in missing parts of a conversation, helping you understand conversational flow and appropriate responses.',
  ...
  [ExerciseType.StorySequencing]: {
    ...
    description: 'A story is presented in jumbled paragraphs or sentences, and you must put you in the correct logical order.',
  ...
  [ExerciseType.Prediction]: {
    name: 'Prediction',
    description: 'You read or listen to the beginning of a story and predict what will happen next, often choosing from given options.',
  ...
  [ExerciseType.RuleDiscovery]: {
    ...
    description: 'You are shown several examples of a grammatical structure and are guided to figure out the rule youselves.',
  ...
  [ExerciseType.SpotTheDifference]: {
    ...
    description: 'You compare two similar sentences or texts and identify the subtle differences in form and meaning.',
  ...
  [ExerciseType.PicturePrompt]: {
    name: 'Picture Prompt',
    description: 'A compelling image is shown, and you must describe it, tell a story about it, or write questions about it. The task is open-ended and promotes creative language use.',
    pedagogy: 'A classic TBLT and Dogme ELT activity. It generates emergent language from you, focusing on fluency and communication with minimal materials.',
    example: 'An image of a deserted youe park. Task: "What happened here?"',
    difficultyRating: Difficulty.A2,
  },
  [ExerciseType.MoralDilemma]: {
    name: 'Moral Dilemma (TBLT)',
    description: 'A scenario posing a difficult ethical choice is presented for a student to consider and write about, explaining your reasoning.',
  ...
  [ExerciseType.WordFormation]: {
    name: 'Word Formation',
    description: 'You are given a root word and a sentence. They must change the form of the word to correctly complete the sentence.',
  ...
  [ExerciseType.ReadingGist]: {
    ...
    description: 'You read a text quickly to understand the main idea, ignoring unknown words and minor details.',
  ...
  [ExerciseType.ReadingDetail]: {
    ...
    description: 'You search a text for specific pieces of information (like names, dates, or numbers) without reading the whole text.',
  ...
  [ExerciseType.FunctionalWriting]: {
    ...
    description: 'You are given a real-world scenario and must write a functional text, like an email, a note, or a complaint.',
  ...
  [ExerciseType.DictoGloss]: {
    ...
    pedagogy: 'A powerful Consciousness-Raising task combining listening/reading and writing to force you to pay close attention to form and structure.',
  ...
  [ExerciseType.RolePlayScenario]: {
    ...
    description: 'A student is given a character, a situation, and a goal, and must write what they would say. This pushes you to produce context-appropriate language.',
    pedagogy: 'Based on Merrill Swain\'s "Pushed Output Hypothesis," this task forces you to produce coherent language, helping you notice gaps in your knowledge.',
  ...
  [ExerciseType.StorytellingFromPrompts]: {
    ...
    description: 'Given a few keywords or short phrases, you must write a coherent story that connects you.',
    pedagogy: 'A Production task that encourages creativity and pushes you to use narrative tenses and cohesive devices to link ideas.',
  ...
  [ExerciseType.JustifyYourOpinion]: {
    ...
    description: 'A student is presented with a statement and must write a response that justifies your agreement or disagreement with supporting arguments.',
  ...
  [ExerciseType.PictureComparison]: {
    ...
    description: 'A student is given descriptions of two related but different scenes and must write a paragraph comparing and contrasting you.',
    pedagogy: 'A Production task that pushes you to use comparative/contrastive language and modals of speculation, developing descriptive and analytical skills.',
    example: 'Scene A is a 1950s kitchen. Scene B is a modern kitchen. Compare you.',
    difficultyRating: Difficulty.C1,
  },
  // Pragmatics & Social English
  [ExerciseType.FunctionMatching]: {
    name: 'Function Matching',
    description: 'You match phrases or utterances to your social function (e.g., apologizing, suggesting, complaining).',
  ...
  [ExerciseType.RegisterSort]: {
    name: 'Register Sort',
    description: 'You are given a list of words or phrases and must sort you into categories like "Formal," "Neutral," and "Informal."',
    pedagogy: 'This Pragmatics task raises awareness of register, a key aspect of social appropriacy. It helps you choose the right language for the right situation.',
  ...
  [ExerciseType.PolitenessScenarios]: {
    ...
    description: 'Given a social situation, you must choose the most appropriate (e.g., most polite) utterance from a set of options.',
    pedagogy: 'This Pragmatics exercise directly teaches politeness strategies and helps you navigate tricky social situations by understanding indirectness and tone.',
