...
<div class="bg-fossil-900/50 rounded-xl ring-1 ring-fossil-700 overflow-hidden font-casual mb-4">
  <button onclick={() => isOpen = !isOpen} class="w-full flex justify-between items-center p-4 text-left bg-fossil-800/50 hover:bg-fossil-800 transition-colors focus:outline-none">
      <div class="flex items-center">
          ...
          <span class="font-semibold text-malachite-100 text-[15px] tracking-tight">Grammar Focus</span>
      </div>
  ...
  {#if isOpen}
      <div class="p-3 border-t border-fossil-700 space-y-4 bg-fossil-900/30">
          <div>
              <div class="flex gap-2">
                  <input
                      ...
                      class="w-full bg-fossil-950 text-malachite-50 border border-fossil-700 rounded-md shadow-sm px-3 py-2 text-sm font-medium focus:ring-1 focus:ring-malachite-500 focus:border-malachite-500 focus:outline-none placeholder-fossil-600 font-serif"
              ...
              {#if focusGrammar.length > 0}
                  <div class="mt-3 flex flex-wrap gap-2">
                      {#each focusGrammar as g}
                          <span class="flex items-center bg-malachite-500/20 text-malachite-200 text-sm font-semibold px-2.5 py-1 rounded-full border border-malachite-500/40 shadow-sm">
                              {g}
          ...
          <div>
              <div class="flex justify-between text-sm font-semibold text-malachite-500/80 mb-1.5">
