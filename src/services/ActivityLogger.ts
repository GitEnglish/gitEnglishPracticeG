...
const uuidv4 = () => crypto.randomUUID(); // Assuming uuid is available via module import or global polyfill
...
// Global instance for Svelte 5 usage
let globalLogger: ActivityLogger | null = null;

export const initActivityLogger = (toolId: string, studentId: string) => {
    globalLogger = new ActivityLogger(toolId, studentId);
    return globalLogger;
};

export const getActivityLogger = () => globalLogger;
